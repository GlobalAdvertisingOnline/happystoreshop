      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-6 md:py-28 lg:px-8 lg:py-36">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/tracking"
              className="inline-flex w-full items-center justify-center rounded-lg bg-brand-blue px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-brand-blue/25 transition-all hover:bg-brand-blue-dark hover:shadow-xl sm:w-auto"
            >
              Track Your Order
            </Link>
            <Link
